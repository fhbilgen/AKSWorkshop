...
export CLUSTER_NAME="aksnetworkdemoazcniovrly"
export RESOURCE_GROUP="aksnetworkdemoazcniovrly-rg"
...
az aks create --resource-group $RESOURCE_GROUP --name $CLUSTER_NAME --node-count 2 --os-sku Ubuntu --location $LOCATION  --network-plugin azure --network-plugin-mode overlay --generate-ssh-keys
