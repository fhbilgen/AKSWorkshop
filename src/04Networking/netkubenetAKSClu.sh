...
export CLUSTER_NAME="aksnetworkdemokubenet"
export RESOURCE_GROUP="aksnetworkdemokubenet-rg"
...
az aks create --resource-group $RESOURCE_GROUP --name $CLUSTER_NAME --node-count 2 --os-sku Ubuntu --location $LOCATION  --network-plugin kubenet --generate-ssh-keys
